...
<link rel="shortcut icon" type="image/x-icon" href="{{asset('website_assets/images/skins/fashion/logo2x.webp')}}" />
    ...
    .imgbg{
        ...
        z-index: -500;
        opacity: 0.6;
        background-image: url("BhamaImg/Self.png");
    ...
    .imgbgf{
        ...
        opacity: 0.6;
        background-image: url("BhamaImg/Bottom.png");
        /* background-repeat: ; */
        z-index: -400;
        width: 100%;
        /* height:300px; */
...
.gallerycol{
	...
	#amazon, #myntra, #flipkart, #nykaa, #ajio{
...
<div class="imgbg">
	...
	<div class="footer1" style="margin-top: -75px;">
		<div class="imgbgf">
			<img src="BhamaImg/Bottom.png" width="100%" alt="" >
		</div>
