...
<div class="col-lg col-xl">
        	...
        	<li><a href="typography.html">Happy Customers</a></li>
        	<li><a href="typography.html">Contact Us</a></li>
				...
				<div class="col-lg col-xl">
                    					<div class="footer-block collapsed-mobile">
                    						...
                    						<div class="collapsed-content">
                    							<ul>
                    	<li><a href="about.html">Dresses</a></li>
                    	<li><a href="contact.html">Tops</a></li>
                    	<li><a href="typography.html">Skirts</a></li>
                    	<li><a href="typography.html">Kurtas</a></li>
                    	<li><a href="typography.html">Clothing Sets</a></li>
                    	 <li><a href="typography.html">Jumpsuits</a></li>
                    </ul>
                    						</div>
                    					</div>
				</div>
					...
					<div class="footer-block collapsed-mobile">
						...
						<div class="collapsed-content">
							<ul>
                                ...
                                <li><a href="contact.html">Cancellation</a></li>
                                <li><a href="typography.html">Happy Customers</a></li>
                                <li><a href="typography.html">Wholesale/Bulk buy</a></li>
                                <li><a href="typography.html">Leave Feedback</a></li>
                                <li><a href="typography.html">Contact Us</a></li>
                            </ul>
						</div>
					</div>
				...
				<div class="col-lg col-xl">
					<div class="footer-block collapsed-mobile">
						...
						<div class="collapsed-content">
							<ul>
                                <li><a href="account-details.html">Shipping Information</a></li>
                                <li><a href="cart.html">Return Policy</a></li>
                                <li><a href="account-wishlist.html">Terms of Service</a></li>
                                <li><a href="account-history.html">Privacy Policy</a></li>
                                <li><a href="account-history.html">Return Center</a></li>
                            </ul>
						</div>
					</div>
				</div>
				<div class="col-lg col-xl">
				    <div class="footer-block collapsed-mobile">
						...
						<div class="collapsed-content">
						    <p><strong>Head Office Address:</strong><br><em>Bhama Designs Private Limited<br>B240, Sector 76, Noida, U.P.- 201301, India</em></p>
    					    <p></p><p><strong>Email</strong>: support@bhamadesigns.com</p><p><strong>Customer care:</strong>&nbsp;+9199999999 (9 AM - 6PM, Mon - Fri)</p>
	...
	<div class="Footer-info  ">
		...
		<div class="row" style="margin-bottom:0px;">
			<div class="col-md-3 alpha" style="padding-top:20px;"> 
			   <img class="footimg"src="https://cdn.shopify.com/s/files/1/1018/4207/files/1_-_Copy.png?1240">
		   </div> 
		   <div class="col-md-3 "> 
		...
		<div class="footer-top">
			<div class="container">
				<div class="row mt-0">
					<div class="col-lg col-xl">
						<div class="footer-block collapsed-mobile">
							<div class="title">
								<h4>About Us</h4> <span class="toggle-arrow"><span></span><span></span></span>
							</div>
							<div class="collapsed-content">
								<ul>
									<li><a href="about.html">About Us</a></li>
					...
					<div class="col-lg col-xl">
						<div class="footer-block collapsed-mobile">
							<div class="title">
								<h4>Online Shopping</h4> <span class="toggle-arrow"><span></span><span></span></span>
							</div>
							<div class="collapsed-content">
								<ul>
									<li><a href="about.html">Dresses</a></li>
					...
					<div class="col-lg col-xl">
						<div class="footer-block collapsed-mobile">
							<div class="title">
								<h4>Help</h4> <span class="toggle-arrow"><span></span><span></span></span>
							</div>
							<div class="collapsed-content">
								<ul>
									<li><a href="about.html">Track Order</a></li>
					...
					<div class="col-lg col-xl">
						<div class="footer-block collapsed-mobile">
							<div class="title">
								<h4>Policy</h4> <span class="toggle-arrow"><span></span><span></span></span>
							</div>
							<div class="collapsed-content">
								<ul>
									<li><a href="account-details.html">Shipping Information</a></li>
					...
					<div class="col-lg col-xl">
						<div class="footer-block collapsed-mobile">
							<div class="title">
								<h4>Contact Us</h4> <span class="toggle-arrow"><span></span><span></span></span>
							</div>
							<div class="collapsed-content">
								<p><strong>Head Office Address:</strong>
									<br><em>Bhama Designs Private Limited<br>B240, Sector 76, Noida, U.P.- 201301, India</em></p>
								<p></p>
								<p><strong>Email</strong>: support@bhamadesigns.com</p>
								<p><strong>Customer care:</strong>&nbsp;+9199999999 (9 AM - 6PM, Mon - Fri)</p>
							</div>
						</div>
					</div>
				</div>
			</div>
			<div class="Footer-info  m-2">
				<div class="container">
					<div class="row" style="margin-bottom:0px;">
						<div class="col-md-3 alpha" style="padding-top:20px;"> <img class="footimg" src="https://cdn.shopify.com/s/files/1/1018/4207/files/1_-_Copy.png?1240"> </div>
						<div class="col-md-3 ">
							<div class="footer-custom">
								<ul class="social-list">
									<li>
			...
			<div class="footer-bottom footer-bottom--bg">
				<div class="container">
					<div class="row">
						<div class="col-md-6 ">
							<div class="footer-copyright text-center"> <a href="#">All Right Reserved</a> by BHAMA DESIGNS PVT. LTD. </div>
						</div>
						<div class="col-md-20 p-1">
							<div class="paymenticons">
								<svg class="payment-icon" viewBox="0 0 38 24" xmlns="http://www.w3.org/2000/svg" height="24" width="38" role="img" aria-labelledby="pi-airtel_money">
								...
								<svg class="payment-icon" viewBox="0 0 38 24" xmlns="http://www.w3.org/2000/svg" height="24" width="38" role="img" aria-labelledby="pi-freecharge">
								...
								<svg class="payment-icon" viewBox="0 0 38 24" xmlns="http://www.w3.org/2000/svg" data-name="Layer 1" width="38" height="24" role="img" aria-labelledby="pi-mobikwik">
								...
								<svg class="payment-icon" viewBox="0 0 38 24" xmlns="http://www.w3.org/2000/svg" height="24" width="38" role="img" aria-labelledby="pi-ola_money">
								...
								<svg class="payment-icon" viewBox="0 0 38 24" xmlns="http://www.w3.org/2000/svg" data-name="Layer 1" width="38" height="24" role="img" aria-labelledby="pi-paytm">
								...
								<svg class="payment-icon" viewBox="0 0 38 24" xmlns="http://www.w3.org/2000/svg" data-name="Layer 1" width="38" height="24" role="img" aria-labelledby="pi-payzapp">
								...
								<svg class="payment-icon" viewBox="0 0 38 24" xmlns="http://www.w3.org/2000/svg" width="38" height="24" role="img" aria-labelledby="pi-rupay">
