	...
	<div class="container">
		<div class="row vert-margin-small">
			<div class="col-sm">
				<a href="{{route('categories')}}" class="collection-grid-3-item image-hover-scale">
					<div class="collection-grid-3-item-img image-container" style="padding-bottom: 68.22%">
						<img src="data:image/gif;base64,R0lGODlhAQABAAAAACH5BAEKAAEALAAAAAABAAEAAAICTAEAOw==" data-src="{{asset('website_assets/images/skins/fashion/banner-category-01.webp')}}" class="lazyload fade-up" alt="Banner">
			...
			<div class="col-sm">
				<a href="{{route('categories')}}" class="collection-grid-3-item image-hover-scale">
					<div class="collection-grid-3-item-img image-container" style="padding-bottom: 68.22%">
						<img src="data:image/gif;base64,R0lGODlhAQABAAAAACH5BAEKAAEALAAAAAABAAEAAAICTAEAOw==" data-src="{{asset('website_assets/images/skins/fashion/banner-category-02.webp')}}" class="lazyload fade-up" alt="Banner">
						<div class="bhama-loader"></div>
					</div>
					<div class="collection-grid-3-caption-bg">
...
<div class="prd prd--style2 prd-labels--max prd-labels-shadow ">
	<div class="prd-inside">
		<div class="prd-img-area">
			<a href="{{url('single-product/'.$row->id)}}" class="prd-img image-hover-scale image-container">
