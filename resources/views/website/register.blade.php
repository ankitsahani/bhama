		...
		<div class="row justify-content-center">
			<div class="col-md-18 col-lg-12">
				...
				<div class="form-wrapper">
					...
					<form action="{{route('user-register')}}" method="post"name="registerForm" id="registerForm"> 
                        @csrf
						<div class="row">
							<div class="col-sm-9">
						...
						<div class="clearfix">
							<input id="checkbox1" name="checkbox1" type="checkbox" name="checkbox"checked="checked">
